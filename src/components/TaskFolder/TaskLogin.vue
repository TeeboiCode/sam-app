            ...
            <div class="mb-4">
              <div class="input-group">
                ...
                <select class="form-select" v-model="role" required>
                  ...
                  <option value="student"><i class="fas fa-graduation-cap"></i> Student</option>
                  <option value="parent"><i class="fas fa-user-friends"></i> Parent</option>
                  <option value="tutor"><i class="fas fa-chalkboard-teacher"></i> Tutor</option>
